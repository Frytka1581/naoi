...
// l1 p1 to nie pusty 
void zamien(int l1, int p1, int l2, int p2) {
    int k = plansza[l1][p1];
    int essa = 1;
    if (l1 - 2 == l2 && p1 - 2 == p2) {
        plansza[l1][p1] = 0;
        plansza[l1 - 2][p1 - 2] = k;
        pozycje[k] = {l1 - 2, p1 - 2};
        ruchy.push_back({k, l1 - 1 + essa, p1 - 1 + essa});
        ruchy.push_back({k, l1 - 2 + essa, p1 - 2 + essa});
        puste_pole.first += 2;
        puste_pole.second += 2;
    }
    if (l1 == l2 && p1 - 2 == p2) {
        ...
        plansza[l1][p1 - 2] = k;
        pozycje[k] = {l1, p1 - 2};
        ruchy.push_back({k, l1 + essa, p1 - 1 + essa});
        ruchy.push_back({k, l1 + essa, p1 - 2 + essa});
        puste_pole.second += 2;
    }
    if (l1 + 2 == l2 && p1 - 2 == p2) {
        plansza[l1][p1] = 0;
    ...
    if (l1 - 2 == l2 && p1 == p2) {
        ...
        plansza[l1 - 2][p1] = k;
        pozycje[k] = {l1 - 2, p1};
        ruchy.push_back({k, l1 - 1 + essa, p1 + essa});
        ruchy.push_back({k, l1 - 2 + essa, p1 + essa});
        puste_pole.first += 2;
    }
    if (l1 + 2 == l2 && p1 == p2) {
        plansza[l1][p1] = 0;
...
vector<pair<int,int>>generuj_droge(pair<int,int> poczatek, pair<int,int> cel){
    ...
    if(poczatek.first<cel.first && poczatek.second <cel.second){
        if(cel.first-poczatek.first!=cel.second-poczatek.second){
            ...
            poczatek.first-=2;
            trasa.push_back({poczatek.first,poczatek.second});
            while(kolejny_cel.first<poczatek.first && kolejny_cel.second+2<poczatek.second){
                poczatek.first-=2; poczatek.second-=2;
                trasa.push_back({poczatek.first,poczatek.second});
    ...
    else if(poczatek.first>cel.first && poczatek.second >cel.second){
        if(poczatek.first-cel.first!=poczatek.second-cel.second){
        while(poczatek.first-cel.first!=poczatek.second-cel.second){
            if(poczatek.first-cel.first > poczatek.second-cel.second)
                poczatek.first-=2;
        ...
        while(kolejny_cel.first-poczatek.first!=kolejny_cel.second-poczatek.second){
            if(kolejny_cel.first-poczatek.first>kolejny_cel.second-poczatek.second)
                poczatek.first+=2;
            else
                poczatek.second+=2;
            trasa.push_back({poczatek.first,poczatek.second});
        ...
        while(poczatek.first<kolejny_cel.first && poczatek.second < kolejny_cel.second){
            ...
            poczatek.second+=2;
            trasa.push_back({poczatek.first,poczatek.second});
            while(kolejny_cel.first-2>poczatek.first && kolejny_cel.second>poczatek.second){
                poczatek.first+=2; poczatek.second+=2;
                trasa.push_back({poczatek.first,poczatek.second});
       ...
       // cout << 1914124 << endl;
        if(cel.first-poczatek.first!=poczatek.second-cel.second){
            while(cel.first-poczatek.first!=poczatek.second-cel.second){
                //cout << 123232 << endl;
                if(cel.first-poczatek.first > poczatek.second-cel.second)
                    poczatek.first+=2;
                else
            ...
            while(poczatek.first-kolejny_cel.first!=kolejny_cel.second-poczatek.second){
                if(poczatek.first-kolejny_cel.first > kolejny_cel.second-poczatek.second)
                    poczatek.first-=2;
                else
                    poczatek.second+=2;
                trasa.push_back({poczatek.first,poczatek.second});
       ...
       // cout << 1914124 << endl;
        if(poczatek.first-cel.first!=cel.second-poczatek.second){
            while(poczatek.first-cel.first!=cel.second-poczatek.second){
                //cout << 123232 << endl;
                if(poczatek.first-cel.first > cel.second-poczatek.second)
                    poczatek.first-=2;
                else
            ...
            while(kolejny_cel.first-poczatek.first!=poczatek.second-kolejny_cel.second){
                if(kolejny_cel.first-poczatek.first > poczatek.second-kolejny_cel.second)
                    poczatek.first+=2;
                else
                    poczatek.second-=2;
                trasa.push_back({poczatek.first,poczatek.second});
            ...
            poczatek.second-=2;
            trasa.push_back({poczatek.first,poczatek.second});
            while(kolejny_cel.first-2>poczatek.first && kolejny_cel.second-2<poczatek.second){
                poczatek.first+=2; poczatek.second-=2;
                trasa.push_back({poczatek.first,poczatek.second});
    ...
    else if(poczatek.second == cel.second && poczatek.first < cel.first){
        while(poczatek.first<cel.first){
            poczatek.first+=2;
            trasa.push_back({poczatek.first,poczatek.second});
        }
        poczatek.second-=2;
        trasa.push_back({poczatek.first,poczatek.second});
        while(poczatek.first>kolejny_cel.first){
            poczatek.first-=2;
            trasa.push_back({poczatek.first,poczatek.second});
        }
        poczatek.second+=2;
        ...
        while(poczatek.second<cel.second){
            poczatek.second+=2;
            trasa.push_back({poczatek.first,poczatek.second});
        }
        poczatek.first-=2;
        trasa.push_back({poczatek.first,poczatek.second});
        while(poczatek.second>kolejny_cel.second){
            poczatek.second-=2;
            trasa.push_back({poczatek.first,poczatek.second});
        }
        poczatek.first+=2;
...
void wysigmuj(int k,pair<int,int>pocz,pair<int,int>kon) {
    vector<pair<int,int>>trasa=generuj_droge(kon,pocz);
    int index = 0;
    int wielkosc = trasa.size();
    pair<int,int>poprzedni = trasa[wielkosc-1];
    while(plansza[kon.first][kon.second]!=k){
        zamien(trasa[index%wielkosc].first,trasa[index%wielkosc].second,poprzedni.first,poprzedni.second);
        poprzedni=trasa[index%wielkosc];
        index++;
    }
}
int main() {
    ...
    // vector<pair<int,int>>droga = generuj_droge({6,8},{6,4});
    ...
    // cout << puste_pole.first << ' ' << puste_pole.second << endl;
    cout << "----------------" << endl;
    wysigmuj(2,pozycje[k-1],puste_pole);
    cout << "Ruchy: ";
